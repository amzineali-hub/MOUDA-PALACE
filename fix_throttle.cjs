const fs = require('fs');
let code = fs.readFileSync('src/components/BarcodeScanner.tsx', 'utf8');

const newCode = `import { useEffect, useRef } from 'react';
...
fs.writeFileSync('src/components/BarcodeScanner.tsx', newCode);
console.log("Throttled barcode scanner");
