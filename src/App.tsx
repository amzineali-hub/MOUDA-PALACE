...
const GuideEcrans = lazy(() => import('./GuideEcrans'));
const AchatsFournisseurs = lazy(() => import('./AchatsFournisseurs'));
const CatalogueProduits = lazy(() => import('./CatalogueProduits'));
const FichesTechniques = lazy(() => import('./FichesTechniques'));
const ProductionJournaliere = lazy(() => import('./ProductionJournaliere'));
...
const DocumentsRestaurant = lazy(() => import('./DocumentsRestaurant'));
